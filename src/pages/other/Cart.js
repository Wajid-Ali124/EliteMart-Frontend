...
const Cart = () => {
  ...
  return (
    <Fragment>
      <SEO titleTemplate="Cart" description="Cart page of EliteMart" />
                  ...
                  <div className="col-lg-12">
                    <div className="cart-shiping-update-wrapper">
                      ...
                      <div className="cart-clear">
                        <button onClick={() => dispatch(deleteAllFromCart())}>Clear Shopping Cart</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-lg-4 col-md-12">
                    <div className="grand-totall">
                      ...
                      <h5>
                        Total products <span>{currency.currencySymbol + cartTotalPrice.toFixed(2)}</span>
                      </h5>
